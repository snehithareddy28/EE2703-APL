    ...
    with open(sys.argv[1]) as f:
        ...
        for l in lines:
            ...
            if(AC == tokens[0]  and tokens[1][0] == 'V'):
                ...
                w = w* 2*math.pi
                break
# if .circuit or .end terms are missing, error message is printed
        if(len(contains)==0):
...
#defining function for adding nodes into node list
def append(n1,n2):
...
#defining function to create matrcices
def populate_M():
    if(ac_flag==1):
